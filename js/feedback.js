...
feedbackLink.addEventListener("click", function (evt) {
    evt.preventDefault();
    feedbackPopup.classList.add("modal-feedback-snow");
...
feedbackClose.addEventListener("click", function (evt) {
    evt.preventDefault();
    feedbackPopup.classList.remove("modal-feedback-snow");
...
window.addEventListener("keydown", function (evt) {
    if (evt.keyCode === 27) {
        if (feedbackPopup.classList.contains("modal-feedback-snow")) {
        evt.preventDefault();
        feedbackPopup.classList.remove("modal-feedback-snow");
        feedbackPopup.classList.remove("modal-error");
        }
